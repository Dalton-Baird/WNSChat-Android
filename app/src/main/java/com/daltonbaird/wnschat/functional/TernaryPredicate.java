 ...
 */
public interface TernaryPredicate<TParam1, TParam2, TParam3>
{
    /**
     ...
     * @param param3 The third parameter of the predicate
     * @return True or false, based on the predicate's implementation
     */
    boolean invoke(TParam1 param1, TParam2 param2, TParam3 param3);
}
